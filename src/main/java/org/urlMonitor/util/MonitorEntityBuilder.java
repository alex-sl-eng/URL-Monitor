...
{
   public static Monitor buildFromProperties(Properties properties) throws InvalidMonitorFileException
   {
      ...
      monitor.setCron(StringUtils.trimToEmpty(properties.getProperty("cronExpression")));
      monitor.setContentRegex(StringUtils.trimToEmpty(properties.getProperty("contentRegex")));

      monitor.setDescription(StringUtils.trimToEmpty(properties.getProperty("description")));
      monitor.setTag(StringUtils.trimToEmpty(properties.getProperty("tag")));
      monitor.setEmailToList(StringUtils.trimToEmpty(properties.getProperty("emailToList")));
   ...
   public static void isMandatoryFieldsPresent(Properties properties) throws InvalidMonitorFileException
   {
      ...
      CronHelper.CronType cronType = CronHelper.getTypeFromExpression(StringUtils.trimToEmpty(properties.getProperty("cronExpression")));
   ...
   public static void validateNameRegexAndTag(Properties properties) throws InvalidMonitorFileException
   {
      String name = StringUtils.trimToEmpty(properties.getProperty("name"));
      String url = StringUtils.trimToEmpty(properties.getProperty("url"));
      CronHelper.CronType cronType = CronHelper.getTypeFromExpression(StringUtils.trimToEmpty(properties.getProperty("cronExpression")));
      ...
      if (!org.quartz.CronExpression.isValidExpression(cronType.getExpression()))
      {
