...
<main>
    <ul class="txt--small list-no-bullet list-slat content-wrapper-small">
        <h3>About</h3>
        <li class="l--push-v-half">
            ...
            <span class="l--push-h-eighth"><c:out
                    value="${buildVersion}"/></span>
        </li>
        <li class="l--push-v-half">
            <span class="label-highlight">Contact</span>
            <span class="l--push-h-eighth"><a
                    href="mailto:${replyTo}">${replyTo}</a></span>
        </li>
        <li class="l--push-v-half">
            <span class="label-highlight">Project</span>
        <span class="l--push-h-eighth">
          <a href="https://github.com/aeng/URL-Monitor"
                  target="_blank">GitHub</a>
        </span>
        <span class="l--push-h-eighth">
          <iframe src="http://ghbtns.com/github-btn.html?user=aeng&repo=url-monitor&type=watch"
                  allowtransparency="true" frameborder="0" scrolling="0"
                  width="56" height="20"></iframe>
        </span>
        <span class="l--push-h-eighth">
        <a href="https://twitter.com/UrlMonitorOrg"
      ...
      <span class="l--push-h-quarter l--push-v-quarter">
        <div id="fb-root"></div>
        <script>(function (d, s, id) {
        ...
        <div class="fb-like" data-href="http://live-urlmonitor.rhcloud.com"
                data-width="58" data-layout="button_count"
                data-show-faces="false"
                data-send="false"></div>
      </span>

      <span class="l--push-h-quarter l--push-v-quarter" style="width: 5.5em">
