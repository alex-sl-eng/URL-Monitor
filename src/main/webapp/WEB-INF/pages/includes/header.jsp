...
<header>
    ...
    <div class="l--float-right txt--huge link right-menu-toggle">
        ...
        <ul class="right-menu">
            <sec:authorize access="isAuthenticated()">
                ...
                <li>
                    <a href="auth/logout"
                            class="l--pad-v-half l--pad-h-half dark-background"><spring:message
                            code="jsp.Logout"/></a>
                </li>
            </sec:authorize>
            <sec:authorize access="! isAuthenticated()">
    ...
    <ul class="message list-h txt--small  l--pad-h-quarter <c:if test="${not empty messages}">visible-message</c:if>">
        <li>
